...
import (
	...
	"github.com/cicutaviroza/hbooking/internal/hbooking/handlers"
	"github.com/cicutaviroza/hbooking/internal/hbooking/repository"
)
...
func (a *App) initServer() error {
	...
	router.GET("/api/v1/bookings/:worlshop_id", a.handlers.ListBookings)
